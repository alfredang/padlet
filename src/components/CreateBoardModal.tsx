...
export default function CreateBoardModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-pop-in overflow-hidden max-h-[90vh] flex flex-col"
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-5 overflow-y-auto scrollbar-thin">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-slate-200 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-violet-300 resize-none placeholder:text-slate-400"
            />
          </div>
              ...
              {LAYOUTS.map((l) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="font-semibold text-sm mt-1.5">{l.label}</div>
            ...
            <div>
              ...
              <div className="space-y-2">
                  ...
                  <div key={i} className="flex items-center gap-2">
                    ...
                    {sections.length > 1 && (
                      <button
                        ...
                        className="w-9 h-9 rounded-lg border border-slate-200 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 grid place-items-center text-slate-500"
                ...
                <button
                  type="button"
                  onClick={addSection}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-dashed border-slate-300 hover:border-violet-400 hover:text-violet-600 text-sm font-medium text-slate-500"
                >
          ...
          <div>
            ...
            <div className="text-xs text-slate-500 mb-2">Solid colors</div>
              ...
              {SOLIDS.map((bg) => (
                <button
                  ...
                  className={`w-9 h-9 rounded-full border-2 transition shadow-sm ${
                    background === bg.value ? "border-violet-600 scale-110" : "border-white"
                  }`}
            ...
            <div className="text-xs text-slate-500 mb-2">Gradients</div>
          ...
          <div className="flex gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2.5 rounded-lg border border-slate-200 hover:bg-slate-50 font-medium"
            >
              Cancel
            </button>
            <button
